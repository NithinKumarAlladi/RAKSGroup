        ...
        return (
            <div className="mainISDiv" >
                ...
                <div className="itServices" >
                    <div className="yellowDiv" id="consulting" ref="consulting" >
                    ...
                    <div className="blackDiv" id="product" ref="product" >
                    ...
                    <div className="blackDiv" id="mobile" ref="mobile" >
                    ...
                    <div className="yellowDiv" id="application" ref="application" >
                    ...
                    <div className="trainingDiv" id="training" ref="training">
